...
const Cart = () => {
  ...
  const placedOrder = async () => {
    alert(`Order placed successfully with ${paymentOption} at ${selectedAddress?.street}`);
    ...
    <div className="flex flex-col md:flex-row mt-16 px-4">
      ...
      <div className="flex-1 max-w-4xl">
        ...
        {cartArray.map((product, index) => (
          <div
            key={index}
            className="grid grid-cols-[2fr_1fr_1fr] text-gray-700 items-center text-sm md:text-base font-medium py-3 border-t"
          >
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 mt-12 md:mt-0 border border-gray-300/70">
        ...
        <div className="mb-6 text-sm">
          ...
          <div className="relative flex justify-between items-start mt-2">
            ...
            <button
              ...
              className="text-primary hover:underline cursor-pointer ml-2 text-sm"
            >
              Change
            </button>
            {showAddress && (
